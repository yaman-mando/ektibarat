          ...
          <div hidden>
            <div class="sed-w w-container">
              ...
              <div class="t-hero-m">
                ...
                <app-train-part-answers-status
                  ...
                  :questionMinSecond="
                    currentQuestionDetailModel!.questionMinTime
                  "
                  :questionMaxSecond="
                    currentQuestionDetailModel!.questionMaxTime
                  "
            ...
            <client-only>
              <lazy-web-train-question-warn-modal
                ...
                "
                :refX="
                  windowSize.isMobileSize ? null : $refs.examPartQuestionRef
                "
              />
              <lazy-web-warn-modal
                ref="warnModalRef"
...
<style lang="scss" src="./user-training-id-page.scss"></style>
