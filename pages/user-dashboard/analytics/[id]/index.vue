              ...
              <div class="space-y-2 min-w-[1020px]">
                ...
                >
                  ...
                  >
                    ...
                    <div class="w-[20%] text-center">
                      <div
                        class="w-full bg-gray-200 h-[18px] rounded-[4px] dark:bg-dark-600"
                      >
                        <div
                          :class="`bg-${getRateColor(child.rate)}`"
                        ...
                        >
                          <span
                            ...
                            class="text-sm"
                            :class="
                              child.rate > 12 ? 'text-white' : 'text-black'
                            "
                          >
                            {{ child.rate }}%
                          </span>
                  ...
                  <div
                    class="flex flex-[25%] h-[100%] items-center rounded-l-[8px] border border-[#BCCCDB]"
                    :class="i % 2 === 0 ? 'bg-white' : 'bg-[#F5F7FA]'"
                  >
                    <div
