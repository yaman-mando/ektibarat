    ...
    <div class="mx-auto">
      ...
      <div class="flex flex-col 2xl:flex-row gap-[20px]">
        ...
        <div class="flex flex-1/3 flex-col gap-y-[20px] w-full 2xl:min-w-[330px]">
          ...
          <!-- rate square -->
          <rateSquare :stdAnlyzeData="stdAnlyzeData" :fetching="panelStore.fetching.studentAnalyze" />

          <!-- plane square -->
          <planeSquare :stdPlaneInfo="stdPlaneInfo" :fetching="panelStore.fetching.studentPlanInfo" />
        ...
        <div class="w-full flex-2/3 2xl:min-w-[710px] h-auto">
          <analyticsChartSquare :fetching="panelStore.fetching.studentAnalyzeChart"
...
async function fetchStudentAnalyzeChart() {
  await panelStore.getStudentAnalyzeChart(selectedPeriodChart.value, selectedCategoryId.value)
