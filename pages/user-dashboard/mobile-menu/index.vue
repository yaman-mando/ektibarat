  ...
  >
    <div class="menu-mobile p-[10px]">
      <div class="rounded-lg border border-[#d0dbe6] overflow-hidden shadow-sm">
        <div
          class="px-4 py-4 border-b border-[#d0dbe6] bg-white flex items-center gap-[10px]"
        >
          <custom-image
        ...
        <div
          v-if="showExamOptions"
          class="border-t border-[#d0dbe6] bg-white"
        >
          <div
        ...
        <div
          class="flex justify-between items-center px-4 py-4 text-right text-dark-63 text-[18px] font-bold cursor-pointer bg-white"
        >
...
const accountItems = [
  {
    ...
    link: '/user-dashboard/personal-setting',
  },
  {
    key: 'subscriptions',
    label: 'الاشتراكات',
...
const helpItems = [
  {
    ...
    link: '/user-dashboard/personal-setting?section=faq',
  },
